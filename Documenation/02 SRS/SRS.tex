...
The clients are the members of the software team designing this project. It is not being created for an external client with external problems or goals. Any and all requirements come from the software team in this case.
